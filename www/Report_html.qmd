...
if(!is.null(params$report_rv$word_cloud)){
  word_cloud_title <- "Word cloud"
  word_cloud_blurb <- "The figure below is a visual depiction of the current text data, with token size corresponding to frequency in the corpus. Thus, a word cloud serves as a quick overview of most frequent terms in the uploaded documents."
