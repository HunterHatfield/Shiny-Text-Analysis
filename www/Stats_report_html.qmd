...
corr_title <- ""
if(!is.null(params$stats_report_rv$corr_plot)){
...
if(!is.null(params$stats_report_rv$corr_plot)){
  ...
  plot <- params$stats_report_rv$corr_plot
}
```
...
# HTML can render the regression result table 
if(!is.null(params$stats_report_rv$reg_result_table)){
...
if(!is.null(params$stats_report_rv$ttest_table)){
  ttest_title <- "T-test"
  ...
  ttest_table <- params$stats_report_rv$ttest_table
}
